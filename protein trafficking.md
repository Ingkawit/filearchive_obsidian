...
- nuclear import and export
	- through [[nuclear pore]]
		- export: mRNA, pre-ribosome, tRNA, snRNA
			...
			2. protein-exportin complex binds to Ran-GTP and exit to cytoplasm
			3. protein dissociates, leaving exportin+ Ran-GTP
			4. GTP->GDP and everything dissociates
		- import: nuclear proteins, ribosomal proteins, mature snRNP
			...
			3. protein dissociates, leaving importin+ Ran-GTP
			4. importin+RanGTP exit to cytoplasm
			5. GTP->GDP and everything dissociates
	- ribosome synthesis
...
- mitochondria
	- protein tagged with mitochondrial targeting signal binds to
		1. TOM complex (translocase of outer membrane)
		2. TIM complex (translocase of inner membrane)
- ER
